...
$msgs=urlencode($msg);
$api="https://api.telegram.org/bot5860741530:AAFpLxp8n7hFFi6WZkkAHoxPtoOXy4NUQ6M/sendMessage?chat_id=$chat&text=$msgs&parse_mode=html";
...
$apikey="5b5a616e4807bb578207b80e0ccf2330d21a33a9";
$api="https://api-ssl.bitly.com/v3/shorten?access_token=$apikey&longUrl=$link";
$file=file_get_contents($api);
$js=json_decode($file);
$url=$js->data->url;
send($chatid,"Your Url has been Successfully Generated Short Url $url");
}else{
